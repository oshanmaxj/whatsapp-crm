...
exports.updateSchedule = async (req, res, next) => { try { return ok(res, await scheduler.update(req.params.id, req.body)); } catch (error) { next(error); } };
exports.deleteSchedule = async (req, res, next) => { try { return ok(res, await scheduler.remove(req.params.id)); } catch (error) { next(error); } };
...
exports.updateScheduledLesson = async (req, res, next) => { try { return ok(res, await scheduler.updateScheduled(req.params.id, req.body)); } catch (error) { next(error); } };
exports.cancelScheduledLesson = async (req, res, next) => { try { return ok(res, await scheduler.cancelScheduled(req.params.id)); } catch (error) { next(error); } };

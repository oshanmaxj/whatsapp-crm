...
module.exports = (err, req, res, next) => {
  ...
  if ([
    ...
    'LEAD_NOT_FOUND','INVALID_LEAD_STATUS','LEAD_STATUS_NOT_INITIALIZED','LEAD_STATUS_UPDATE_FORBIDDEN','STALE_LEAD_STATUS_UPDATE','INVALID_DATE_RANGE','UNIFIED_LEAD_STATUS_CONFLICT'
  ].includes(err.code)) {

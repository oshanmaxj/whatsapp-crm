...
const SmsCampaignRecipient = require('./smsCampaignRecipient.model');
...
const models = {
  ...
  SmsCampaign: SmsCampaign(sequelize, Sequelize.DataTypes),
  SmsCampaignRecipient: SmsCampaignRecipient(sequelize, Sequelize.DataTypes),

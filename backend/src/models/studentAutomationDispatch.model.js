module.exports = (sequelize, DataTypes) => {
  const StudentAutomationDispatch = sequelize.define('StudentAutomationDispatch', {
    ...
    templateVersion: { type: DataTypes.STRING(80), allowNull: true },
    originEvent: { type: DataTypes.STRING(80), allowNull: true },
    forceAttempt: { type: DataTypes.STRING(80), allowNull: true },

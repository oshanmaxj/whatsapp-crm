...
const flowMediaPublicRoutes = require('./flowMediaPublic.routes');
...
const aiAgentRoutes = require('./aiAgent.routes');
const reminderSequenceRoutes = require('./reminderSequence.routes');
...
const facebookCommentAutoHideRuleRoutes = require('./facebookCommentAutoHideRule.routes');
...
router.use('/public/flow-media', flowMediaPublicRoutes);
...
router.use('/facebook-comment-auto-hide-rules', facebookCommentAutoHideRuleRoutes);
...
router.use('/reminder-sequences', reminderSequenceRoutes);

...
router.post('/test-otp-configuration', requirePermission('connect-whatsapp.edit'), whatsappSettingsController.testOtpConfiguration.bind(whatsappSettingsController));

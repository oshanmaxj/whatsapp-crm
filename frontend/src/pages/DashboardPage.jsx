...
function DashboardPage() {
  ...
  const metrics = [
    ...
    { label: 'Follow-ups Due Today', value: summary.totals.followupsDueToday || 0, icon: <EventAvailableIcon sx={{ color: '#a15c00' }} />, tone: '#fff4df' },
    { label: 'Overdue Follow-ups', value: summary.totals.overdueFollowups || 0, icon: <EventAvailableIcon sx={{ color: '#ba1a1a' }} />, tone: '#feecec' },
    ...
    { label: 'Payment Pending Leads', value: summary.totals.paymentPendingLeads || 0, icon: <PaymentsIcon sx={{ color: '#a15c00' }} />, tone: '#fff4df' },
